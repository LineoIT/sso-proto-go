...
const (
	...
	AuthService_RegisterOrLoginPhone_FullMethodName  = "/sso.AuthService/RegisterOrLoginPhone"
	...
	AuthService_GetUserByPhone_FullMethodName        = "/sso.AuthService/GetUserByPhone"
...
type AuthServiceClient interface {
	...
	GetUserByPhone(ctx context.Context, in *IdSchema, opts ...grpc.CallOption) (*User, error)
...
func (c *authServiceClient) GetUserByPhone(ctx context.Context, in *IdSchema, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
	err := c.cc.Invoke(ctx, AuthService_GetUserByPhone_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	GetUserByPhone(context.Context, *IdSchema) (*User, error)
...
func (UnimplementedAuthServiceServer) GetUserByPhone(context.Context, *IdSchema) (*User, error) {
...
func _AuthService_RegisterOrLoginPhone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(AuthServiceServer).RegisterOrLoginPhone(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
func _AuthService_GetUserByPhone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IdSchema)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).GetUserByPhone(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_GetUserByPhone_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetUserByPhone(ctx, req.(*IdSchema))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RegisterOrLoginPhone",
			Handler:    _AuthService_RegisterOrLoginPhone_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _AuthService_GetUserByPhone_Handler,
		},
		{
